...
vraag_data = {
    ...
    "B4": {"type": "consequentie", "tekst": "Je loopt in een hinderlaag van de tegenpartij.", "wacht": 120},
    "B5": {"type": "opdracht", "tekst": "Voer een middeleeuwse ridderceremonie uit en sla iemand tot ridder met een tak.", "codewoord": "hekserij"},
    "B6": {"type": "opdracht", "tekst": "Als jij koning(in) was, wat zou je eerste wet zijn? Deze wet moet je team het hele weekend volgen.", "codewoord": "hofnar"},
    ...
    "C3": {"type": "opdracht", "tekst": "Voer een zwaardgevecht met dropveters in slow motion.", "codewoord": "slot"}, 
    "C4": {"type":  "consequentie", "tekst": "De rivier is te diep – je loopt 2 minuten vertraging op.", "wacht": 120},
    ...
    "F1": {"type": "vraag","tekst": "Wat is de functie van een banier?\nA) Een kreet waarmee je het leger aanvuurt\nB) Een kledingstuk gedragen door ridders\nC) Een vlag met symbool van een ridder of familie",
    "antwoord": "C"},
    "F2": {"type":  "vraag", "tekst": "Wat was de belangrijkste functie van een slotgracht rond een kasteel? \nA) Voor de visserij\nB) Ter verdediging \nC) Voor extra status", "antwoord": "B"},
    "F3": {"type": "consequentie", "tekst": "Geheime kaart ontvangen – je hoeft geen opdracht te doen.", "wacht": 0},
    "F4": {"type": "consequentie", "tekst": "Je wapens zijn verdwenen; gebruik bij de volgende opdracht alleen je linkerhand.", "wacht": 0},  
